...
export default class AppCountry extends Component {
    ...
    static countryType = CountryContext;
    ...
    selectCountry(ctry) {
        this.setCountry(ctry);
    }

    render() {
        const filteredList = CountryStateCityData.filter(ctry => this.state.searchInput === "" || ctry.name.toLowerCase().includes(this.state.searchInput.toLowerCase()));
                ...
                <div className="paper-container-body">
                    ...
                    <div className="paper-container-list">
                        {filteredList.map(ctry => (
                            <div className="c-s-c-list" key={ctry.id} onClick={e => this.selectCountry(ctry)}>
